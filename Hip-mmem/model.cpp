                      ...
                      float Dx, float Dt, float W0, int Nb, int Nx, int Ny)
{
  ...
  hipMalloc((void**)&(Model->dRho),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dDrhox),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dDrhoy),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dKappa),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dDkappax),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dDkappay),sizeof(float)*Nx*Ny);

  hipMalloc((void**)&(Model->dAlpha1x),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dAlpha1y),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dAlpha2x),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dAlpha2y),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dEta1x),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dEta1y),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dEta2x),sizeof(float)*Nx*Ny);
  hipMalloc((void**)&(Model->dEta2y),sizeof(float)*Nx*Ny);
  ...
  // Copy to GPU
  hipMemcpy(Model->dRho, Model->Rho,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dDrhox, Model->Drhox,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dDrhoy, Model->Drhoy,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dKappa, Model->Kappa,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dDkappax, Model->Dkappax,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dDkappay, Model->Dkappay,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);

  hipMemcpy(Model->dAlpha1x, Model->Alpha1x,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dAlpha1y, Model->Alpha1y,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dAlpha2x, Model->Alpha2x,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dAlpha2y, Model->Alpha2y,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dEta1x, Model->Eta1x,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dEta1y, Model->Eta1y,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dEta2x, Model->Eta2x,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
  hipMemcpy(Model->dEta2y, Model->Eta2y,sizeof(float)*Nx*Ny,hipMemcpyHostToDevice);
